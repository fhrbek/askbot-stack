class askbot::params {
  ...
  $askbot_db_name = hiera( 'askbot::db_name'     , 'askbot' )
  $askbot_db_user = hiera( 'askbot::db_username' , 'askbot' )
  $askbot_db_pass = hiera( 'askbot::db_password' ) # Fail if no password
  ...
  case $::osfamily {
    ...
    default: { fail( "${module_name} does not work on ${::osfamily}" ) }
  }
